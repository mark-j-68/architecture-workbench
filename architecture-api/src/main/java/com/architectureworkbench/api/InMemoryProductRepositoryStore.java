...
final class InMemoryProductRepositoryStore implements ProductRepositoryStore {
 private final Map<String,ProductModels.Product> products=new ConcurrentHashMap<>(); private final Map<String,ApiDtos.ProductCompositionView> compositions=new ConcurrentHashMap<>(); private final Map<String,List<ApiDtos.ProductDependencyCompositionView>> dependencies=new ConcurrentHashMap<>();
